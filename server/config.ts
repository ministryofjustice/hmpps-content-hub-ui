...
export default {
  ...
  establishments: [
    { code: 'BFI', name: 'bedford', displayName: 'HMP Bedford', youth: false, languages: ['en'], active: [] },
    { code: 'BWI', name: 'berwyn', displayName: 'HMP Berwyn', youth: false, languages: ['en', 'cy'], active: [] },
    { code: 'BLI', name: 'bristol', displayName: 'HMP Bristol', youth: false, languages: ['en'], active: [] },
    { code: 'BNI', name: 'bullingdon', displayName: 'HMP Bullingdon', youth: false, languages: ['en'], active: [] },
    { code: 'CFI', name: 'cardiff', displayName: 'HMP Cardiff', youth: false, languages: ['en', 'cy'], active: [] },
    { code: 'CDI', name: 'chelmsford', displayName: 'HMP Chelmsford', youth: false, languages: ['en'], active: [] },
    {
      code: 'CKI',
      name: 'cookhamwood',
    ...
    { code: 'EEI', name: 'erlestoke', displayName: 'HMP Erlestoke', youth: false, languages: ['en'], active: [] },
    { code: 'FYI', name: 'felthama', displayName: 'HMYOI Feltham A', youth: true, languages: ['en'], active: [] },
    { code: 'FMI', name: 'felthamb', displayName: 'HMYOI Feltham B', youth: true, languages: ['en'], active: [] },
    { code: 'GHI', name: 'garth', displayName: 'HMP Garth', youth: false, languages: ['en'], active: [] },
    { code: 'LHI', name: 'lindholme', displayName: 'HMP Lindholme', youth: false, languages: ['en'], active: [] },
    { code: 'NHI', name: 'newhall', displayName: 'HMPYOI New Hall', youth: false, languages: ['en'], active: [] },
    {
      code: 'RNI',
      name: 'ranby',
    ...
    { code: 'STI', name: 'styal', displayName: 'HMPYOI Styal', youth: false, languages: ['en'], active: [] },
    { code: 'SLI', name: 'swaleside', displayName: 'HMP Swaleside', youth: false, languages: ['en'], active: [] },
    { code: 'MTI', name: 'themount', displayName: 'HMP The Mount', youth: false, languages: ['en'], active: [] },
    {
      code: '',
      name: 'thestudio',
      displayName: 'HMP The Studio',
      youth: false,
      languages: ['en', 'cy'],
      active: ['DEVELOPMENT'],
    },
    { code: 'WLI', name: 'wayland', displayName: 'HMP Wayland', youth: false, languages: ['en'], active: [] },
    {
      code: 'WNI',
      name: 'werrington',
    ...
    { code: 'WYI', name: 'wetherby', displayName: 'HMYOI Wetherby', youth: true, languages: ['en'], active: [] },
    { code: 'WCI', name: 'winchester', displayName: 'HMP Winchester', youth: false, languages: ['en'], active: [] },
    { code: 'WHI', name: 'woodhill', displayName: 'HMP Woodhill', youth: false, languages: ['en'], active: [] },
  ],
  sqs: {
