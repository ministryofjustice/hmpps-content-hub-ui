...
export default {
  ...
  establishments: [
    ...
    { code: 'CFI', name: 'cardiff', displayName: 'HMP Cardiff', youth: false, languages: ['en', 'cy'] },
    { code: 'CDI', name: 'chelmsford', displayName: 'HMP Chelmsford', youth: false, languages: ['en'] },
    { code: 'CKI', name: 'cookhamwood', displayName: 'HMP Cookham Wood', youth: false, languages: ['en'] },
    { code: 'EEI', name: 'erlestoke', displayName: 'HMP Erlestoke', youth: false, languages: ['en'] },
    { code: 'FYI', name: 'felthama', displayName: 'HMYOI Feltham A', youth: true, languages: ['en'] },
    { code: 'FMI', name: 'felthamb', displayName: 'HMYOI Feltham B', youth: true, languages: ['en'] },
    { code: 'GHI', name: 'garth', displayName: 'HMP Garth', youth: false, languages: ['en'] },
    { code: 'LHI', name: 'lindholme', displayName: 'HMP Lindholme', youth: false, languages: ['en'] },
    { code: 'NHI', name: 'newhall', displayName: 'HMPYOI New Hall', youth: false, languages: ['en'] },
    { code: 'RNI', name: 'ranby', displayName: 'HMP Ranby', youth: false, languages: ['en'] },
    { code: 'SHI', name: 'stokeheath', displayName: 'HMPYOI Stoke Heath', youth: false, languages: ['en'] },
    ...
    { code: 'WHI', name: 'woodhill', displayName: 'HMP Woodhill', youth: false, languages: ['en'] },
  ],
  sqs: {
